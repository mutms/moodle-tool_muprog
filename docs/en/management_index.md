...
| Allocate users to programs         | Allocate users manually and archived allocation. Depends on allocation source logic.                  |
| De-allocate users from programs    | Remove allocated users manually and restore archived allocations. Depends on allocation source logic. |
