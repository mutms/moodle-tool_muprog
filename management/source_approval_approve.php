...
$currenturl = new moodle_url('/admin/tool/muprog/management/source_approval_approve.php', ['id' => $id]);
...
$form = new \tool_muprog\local\form\source_approval_approve(null, ['request' => $request, 'user' => $user, 'program' => $program, 'context' => $context]);
...
if ($data = $form->get_data()) {
    tool_muprog\local\source\approval::approve_request($request->id);
