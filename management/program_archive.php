...
$currenturl = new moodle_url('/admin/tool/muprog/management/program_archive.php', ['id' => $program->id]);
management::setup_program_page($currenturl, $context, $program, 'program_general');

$form = new \tool_muprog\local\form\program_archive(null, ['program' => $program]);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('program_archive', 'tool_muprog'));
