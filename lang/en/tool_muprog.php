...
$string['attendance'] = 'Offline attendance';
$string['attendance_effective'] = 'Effective date';
$string['attendance_status'] = 'Status';
$string['attendance_status_completed'] = 'Completed';
$string['attendance_status_failed'] = 'Failed';
$string['attendance_status_noshow'] = 'No show';
$string['attendance_take'] = 'Take attendance';
...
$string['credits_progress'] = 'Current credits: {$a->current}/{$a->total}';
$string['credits_requiredcredits'] = 'Required credits: {$a}';
...
$string['item'] = 'Item';
$string['item_create_attendance'] = 'Add offline attendance';
...
$string['item_update_attendance'] = 'Update offline attendance';
...
$string['muprog:takeattendance'] = 'Take offline attendance';
...
$string['privacy:metadata:field:status'] = 'Status';
$string['privacy:metadata:field:teakenby'] = 'Attendance taken by';
...
$string['privacy:metadata:field:timeeffective'] = 'Effective date';
...
$string['updateattendance'] = 'Update offline attendance';
