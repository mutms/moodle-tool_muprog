...
$string['source_externaldb_allownew_desc'] = 'Allow adding new _external database allocation_ sources to programs';
$string['source_externaldb_notconfigured'] = 'External database allocation is not available because the data source is not configured.';
$string['source_externaldb_remotetable'] = 'Remote table name';
$string['source_externaldb_programfield'] = 'Remote program field';
$string['source_externaldb_programvalue'] = 'Remote program value';
$string['source_externaldb_programvalue_help'] = 'Leave empty to use the program ID number when filtering records in the remote table.';
$string['source_externaldb_userfield'] = 'Remote user field';
$string['source_externaldb_usermapping'] = 'Match users via';
$string['source_externaldb_timeallocatedfield'] = 'Remote allocation date field';
$string['source_externaldb_timestartfield'] = 'Remote start date field';
$string['source_externaldb_timeduefield'] = 'Remote due date field';
$string['source_externaldb_timeendfield'] = 'Remote end date field';
$string['source_externaldb_sourceinstancefield'] = 'Remote unique allocation field';
$string['source_externaldb_statusfield'] = 'Remote status field';
$string['source_externaldb_statusvalue'] = 'Active status value';
$string['source_externaldb_statusvalue_help'] = 'When set, only rows where the status field matches this value are imported.';
$string['source_externaldb_syncdeletions'] = 'Archive missing allocations';
$string['source_externaldb_syncdeletions_desc'] = 'Archive allocations created by this source when they disappear from the external dataset.';
$string['source_externaldb_syncdeletions_help'] = 'When enabled, any allocations created by the External database source that no longer appear in the external dataset are archived automatically.';
$string['source_externaldb_settingsmissing'] = 'External database connection details are missing. Configure them in the plugin settings.';
$string['source_externaldb_statusconfigured'] = 'Active (table: {$a->table})';
$string['runexternaldballocation'] = 'Run External Database Allocation';
$string['runexternaldballocation_confirm'] = 'Run the external database synchronisation now? Allocations missing from the external dataset will be archived when archiving is enabled.';
$string['runexternaldballocation_triggered'] = 'External database allocation finished.';
$string['externaldbsettings'] = 'External database allocation';
$string['externaldbsettings_desc'] = 'Configure the connection used by the External database allocation source.';
$string['externaldbtype'] = 'Database type';
$string['externaldbhost'] = 'Database host';
$string['externaldbname'] = 'Database name';
$string['externaldbuser'] = 'Database user';
$string['externaldbpass'] = 'Database password';
$string['externaldbencoding'] = 'Remote encoding';
$string['externaldbsetupsql'] = 'Setup SQL';
$string['externaldbsybasequoting'] = 'Enable Sybase style quoting';
$string['externaldbdebug'] = 'Enable debug output';
