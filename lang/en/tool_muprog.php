...
$string['muprog:allocate'] = 'Allocate students to programs';
$string['muprog:archive'] = 'Archive program allocations';
$string['muprog:clone'] = 'Allow cloning of program content and settings';
