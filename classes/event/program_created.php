 ...
 */
final class program_created extends \core\event\base {
    /**
     * Helper for event creation.
     *
     * @param \stdClass $program
     *
     * @return program_created|static
     */
    ...
    public function get_description() {
        return "The user with id '$this->userid' created program with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('event_program_created', 'tool_muprog');
    }
