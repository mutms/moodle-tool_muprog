...
class fields_handler extends \core_customfield\handler {
    ...
    public function get_configuration_url(): \moodle_url {
        return new \moodle_url('/admin/tool/muprog/management/customfield.php', []);
    }
    ...
    public function config_form_definition(\MoodleQuickForm $mform) {
        $mform->addElement('header', 'programcustomfields', get_string('customfieldsettings', 'tool_muprog'));
